const projects = [
  {
    ...
    projectLink: 'https://github.com/corygold-dev/chickagotchi',
    tools: ['JavaScript', 'Node.js', 'Express.js', 'PostgreSQL', 'LESS'],
  },
  {
    id: 2,
    title: 'Enrollments Tool',
    image: '/images/enrollments_tool.png',
    ...
    projectLink: 'https://github.com/corygold-dev/enrollments-crud-app',
    tools: ['React', 'Redux', 'Express.js', 'Node.js', 'PostgreSQL', 'LESS'],
  },
  {
    id: 3,
    title: 'My Portfolio Website',
    image: '/images/corygolddev.png',
    ...
    projectLink: 'https://github.com/corygold-dev/corygold.dev',
    tools: ['React', 'Node.js', 'LESS'],
  },
  {
    id: 4,
    title: 'Simpli Money',
    image: '/images/simpli_money.png',
    ...
    projectLink: 'https://github.com/corygold-dev/simpli-money',
  ...
  },
  {
    ...
    projectLink: 'https://github.com/corygold-dev/2min.fit',
  ...
  },
  {
    ...
    projectLink: 'https://github.com/corygold-dev/billionaire-app',
  ...
  },
  {
    id: 7,
    title: 'FocusFit',
    image: '/images/focusfit.png',
    altText: 'Focus Fit project image',
    description:
      'A simple focus-timer app where users work in timed intervals and complete quick micro-workouts during breaks to stay active and energized.',
    projectLink: 'https://github.com/corygold-dev/focusfit',
    liveLink: 'https://testflight.apple.com/join/91hwsDtt',
